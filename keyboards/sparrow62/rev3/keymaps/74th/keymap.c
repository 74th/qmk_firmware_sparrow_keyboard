...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC_BASE_L] = LAYOUT(
    // /-------+-------+-------+-------+-------+-------\                 /-------+-------+-------+-------+-------+-------.
          RED,   KC_1,   KC_2,   KC_3,   KC_4,   KC_5,                     KC_7,   KC_8,   KC_9,   KC_0,  KC_MINS,KC_BSLS,
    // |-------+-------+-------+-------+-------+-------+-------\ /-------+-------+-------+-------+-------+-------+-------|
    ...
    [_MAC_RAISE_L] = LAYOUT(
    // /-------+-------+-------+-------+-------+-------\                 /-------+-------+-------+-------+-------+-------.
        _______,G(KC_F1),G(KC_F2),G(KC_F3),G(KC_F4),G(KC_F5),          G(KC_F6),G(KC_F7),G(KC_F8),G(KC_9),G(KC_F10),G(KC_F11),
    // |-------+-------+-------+-------+-------+-------+-------\ /-------+-------+-------+-------+-------+-------+-------|
