...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * │ Z │ X │ C │ V │ B │ ] │     │ N │ M │ , │ . │ / │Sft│
     * └───┼───┼───┴┬──┴─┬─┴──┬┴───┐ ├───┴┬──┴─┬─┴──┬┴──┬┴───┘
     *     │ESC│LALT│LCTL│SPC │MBt1│ │Ent │RAIS│BSpc│GUI|
     *     └───┴────┴────┴────┴────┘ └────┴────┴────┴───┘
     */
    [_BASE] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_RBRC,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_ESC,  KC_LALT, KC_LCTL, KC_SPC,  KC_BTN1, KC_ENT,  MO(1),   KC_BSPC, KC_RGUI
    ),
    /*
     * ┌───┬───┬───┬───┬───┐         ┌───┬───┬───┬───┬───┬───┐
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_GRV,  _______, _______, _______, _______, KC_F6,            _______, _______, _______, _______, _______, _______,
        KC_TAB,  _______, _______, _______, _______, _______,          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
        _______, _______, _______, _______, _______, KC_PSCR,          KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______,
