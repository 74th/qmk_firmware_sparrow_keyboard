...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC_RAISE_L] = LAYOUT(
        ...
        S(KC_1),  S(KC_2),  S(KC_3),  S(KC_4),  S(KC_5),  S(KC_6),            S(KC_7),  KC_PGDN,  KC_PGUP,  S(KC_0),  KC_UNDS,  KC_EQL,
        KC_GRV,   S(KC_GRV),PR_WINm,  PR_SCRm,  KC_F12,   _______,            KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_HOME,  KC_END,
