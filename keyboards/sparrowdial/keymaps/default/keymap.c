...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_RBRC,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                          KC_ESC,  KC_LALT, KC_LCTL, KC_SPC,  KC_BTN1, KC_ENT,  KC_BSPC, MO(1),   KC_MS_BTN1
    ),
    /*
     * ┌───┬───┬───┬───┬───┐         ┌───┬───┬───┬───┬───┬───┐
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_TAB,  _______, _______, _______, _______, _______,          _______, KC_PGDN, KC_PGUP, _______, _______, _______,
